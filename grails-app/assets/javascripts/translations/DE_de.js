	...
	$translateProvider.translations('de', {
		...
		FAQ: {
			...
			VIDEO_FORMATS: {
				...
				TEXT: "THCStream unterstützt im Moment nur Formate für den HTML5 player. Du kannst testen ob deine Videodatei HTML5 kompatiebel ist, indem du diese in ein/en leeren " +
			...
			INVITE_USERS: {
				...
				TEXT:"Du kannst deine Videos auf THCStream teilen, indem du deine Frende einlädst. Gehe zum Benutzer Menu und klicke auf den Einladen Button. Fülle das Formular aus" +
			...
			FAVORITE_GENRES: {
				TITLE: "Wie beeinflussen die Lieblings-Genres des Nutzers THCStream?",
				TEXT: "Kommt bald..."
			},
			USEFUL_LINKS: {
