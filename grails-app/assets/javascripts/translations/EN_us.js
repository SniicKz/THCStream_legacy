	...
	$translateProvider.translations('en', {
		...
		FAQ: {
			...
			VIDEO_FORMATS: {
				...
				TEXT: "THCStream supports currently only the video file formats supported by HTML5 player. You can test if your video file is HTML5 player compatible by dragging and dropping" +
			...
			INVITE_USERS: {
				...
				TEXT:"You can share your videos with your friends by inviting them to use your hosted THCStream. Go to the Users menu and click Invite User button. Fill in the invite form and" +
			...
			FAVORITE_GENRES: {
				TITLE: "How do user's favorite genres affect THCStream?",
				TEXT: "Coming soon..."
			},
			USEFUL_LINKS: {
				TITLE: "Useful links",
