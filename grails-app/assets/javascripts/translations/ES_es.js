	...
	$translateProvider.translations('es', {
		...
		FAQ: {
			...
			VIDEO_FORMATS: {
				...
				TEXT: "THCStream soporta actualmente solo aquellos formatos de vídeo soportados por el reproductor HTML5. Puedes comprobar si un archivo de vídeo es compatible con HTML5 arrastrándolo" +
			...
			INVITE_USERS: {
				...
				TEXT:"Puedes compartir tus vídeos con tus amigos invitándoles a usar tu THCStream. Ve al menú de Usuarios y haz click en el botón de Invitar Usuario. Rellena el formulario de invitación y" +
			...
			FAVORITE_GENRES: {
				TITLE: "¿Cómo afectan a THCStream los géneros favoritos del usuario?",
				TEXT: "Próximamente..."
			},
			USEFUL_LINKS: {
