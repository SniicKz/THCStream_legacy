    ...
    <td class="container" bgcolor="#FFFFFF">
      ...
      <div class="content">
        ...
        <table>
          <tr>
            <td>
              <h1>New Content on THCStream</h1>
              <p style="font-size: 16px;">Recently, the following content was added to THCStream</p>
              ...
              <a href="${streama.Settings.findBySettingsKey('Base URL')?.value}/" class="btn-primary" style="font-size: 20px;">Visit THCStream now!</a>
            </td>
          </tr>
        </table>
      </div>
